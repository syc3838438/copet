...
module.exports = function initMenu(ctx) {
  ...
  const appMode = ctx.appMode || { productName: "Clawd on Desk", features: {} };

  function featureEnabled(featureName) {
    if (!featureName) return true;
    return !appMode.features || appMode.features[featureName] !== false;
  }
  ...
  function createTray() {
    ...
    ctx.tray.setToolTip(appMode.productName || "Clawd Desktop Pet");
    buildTrayMenu();
  }
