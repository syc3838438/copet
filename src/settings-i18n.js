...
(function initSettingsI18n(root) {
  ...
  Object.assign(STRINGS.zh, {
    settingsTitle: "CoPets 桌宠设置",
    settingsSubtitle: "调整桌宠外观、互动动作、主题和音效。",
    sidebarGeneral: "通用",
    sidebarTheme: "主题",
    sidebarAnimMap: "动画映射",
    sidebarAnimOverrides: "动画与音效",
    sidebarShortcuts: "快捷键",
    sidebarAbout: "关于",
    sectionAppearance: "桌宠",
    sectionStartup: "启动",
    sectionBubbles: "提示",
    rowSoundDesc: "播放桌宠提示音和互动音效。",
    rowLowPowerIdleMode: "低功耗待机",
    rowLowPowerIdleModeDesc: "桌宠静止几秒后暂停待机动画；有活动时立即恢复。",
    rowOpenAtLoginDesc: "登录系统时自动启动 CoPets 桌宠。",
    rowKeepSizeAcrossDisplaysDesc: "移动到另一台显示器时不自动缩放。滑块仍按当前显示器比例调整桌宠。",
    shortcutsSubtitle: "设置显示/隐藏桌宠的全局快捷键。留空即可解绑。",
    shortcutLabelPermissionAllow: "权限：允许",
    shortcutLabelPermissionDeny: "权限：拒绝",
    themeTitle: "主题",
    themeSubtitle: "选择桌宠主题，或导入 Codex 桌宠包和本地主题包。",
    themeActionGroupCodexPets: "Codex 桌宠包",
    themeRefreshImportedPets: "刷新 Codex 桌宠包",
    themeImportPetZip: "导入 Codex 桌宠包（.zip）",
    themeImportUserThemeZip: "导入本地主题包（.zip）",
    themeImportUserThemeZipHint: "主题 zip 需要包含 theme.json；Codex 桌宠包请使用上方入口导入。",
    themeGroupImportedCodexPets: "已导入的 Codex 桌宠",
    themeBadgeCodexPet: "Codex 桌宠",
    toastCodexPetsRefreshOk: (imported, updated, unchanged, removed, invalid, switched) =>
      `Codex 桌宠已刷新：新增 ${imported}，更新 ${updated}，未变化 ${unchanged}，移除 ${removed}${invalid ? `，无效 ${invalid}` : ""}${switched ? "，当前主题已切回默认主题" : ""}。`,
    toastCodexPetsRefreshFailed: (message) => `刷新 Codex 桌宠失败：${message}`,
    toastCodexPetZipImportOk: (name) => `已导入“${name}”并切换使用。`,
    toastCodexPetZipImportFailed: (message) => `导入 Codex 桌宠包失败：${message}`,
    toastCodexPetRemoveOk: (name, switched) => `已移除“${name}”${switched ? "，并切回默认主题" : ""}。`,
    toastCodexPetRemoveFailed: (message) => `移除桌宠失败：${message}`,
    animMapSubtitle: "关闭某些桌宠动画或音效。事件仍会触发，但对应表现会被跳过。",
    aboutTitle: "关于 CoPets 桌宠",
    aboutSubtitle: "一个可以导入 Codex 桌宠包的独立桌宠软件。",
    aboutTagline: "把桌面留一点位置给会动的小伙伴。",
    aboutFooter: "CoPets 桌宠基于开源项目改造，面向独立桌宠体验。",
    aboutEasterEggToast: "桌宠正在认真营业。",
  });
