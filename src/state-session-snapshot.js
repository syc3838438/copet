...
let readCodexThreadName = () => null;
try {
  const codexSessionIndex = require("../hooks/codex-session-index");
  if (codexSessionIndex && typeof codexSessionIndex.readCodexThreadName === "function") {
    readCodexThreadName = codexSessionIndex.readCodexThreadName;
  }
} catch {}
